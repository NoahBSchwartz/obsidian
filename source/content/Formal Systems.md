The theory of computing things (without a computer)
# Combinator Logic
Anything on computer can be defined as combinator logic
- Variables = x, y, z, Combinators = I (Identity), K (currying), S
	Ex. Program = (SKIKxIxyIx)
- Rules: IP = P, KPQ = P, SPQR = PR(QR) (P applied to R, Q applied to R)
```
D = SII //doubling combinator
Dx -> SIIx -> Ix(Ix) -> xx
```
# Lambda Calculus![[Screenshot 2025-10-21 at 10.42.16 PM.png]]
...
- Reductions
	...
	2. β Reduction: how to simplify abstractions (function acting on variables)      ie. (λx.x^2)7 = β​49,      (λx.x)(λy.y) = β(λy.y)![[Screenshot 2025-10-21 at 10.45.35 PM.png]]
